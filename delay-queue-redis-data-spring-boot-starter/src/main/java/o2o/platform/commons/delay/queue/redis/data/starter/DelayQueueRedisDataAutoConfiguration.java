 ...
 */
@Configuration
public class DelayQueueRedisDataAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public RedisOpService redisOpService(RedisConnectionFactory redisConnectionFactory) {
        return new SpringRedisTemplate(redisConnectionFactory);
    }
